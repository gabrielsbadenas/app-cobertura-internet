...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "fallbackExclusionList": [\
      ["app-cobertura-internet", ["workspace:."]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      [null, [\
        [null, {\
          "packageLocation": "./",\
          "packageDependencies": [\
            ["node-json-db", "npm:2.1.0"]\
          ],\
          "linkType": "SOFT"\
        }]\
      ]],\
      ["app-cobertura-internet", [\
        ["workspace:.", {\
          "packageLocation": "./",\
          "packageDependencies": [\
            ["app-cobertura-internet", "workspace:."],\
      ...
      ["node-json-db", [\
        ["npm:2.1.0", {\
          "packageLocation": "./.yarn/cache/node-json-db-npm-2.1.0-cdb84c575d-ed41e35cce.zip/node_modules/node-json-db/",\
          "packageDependencies": [\
            ["node-json-db", "npm:2.1.0"],\
            ["atomically", "npm:1.7.0"]\
          ],\
